...
export const es: TranslationKeys = {
  ...
  faq: {
    ...
    items: {
      ...
      q6: { question: "¿Qué clasificación de fuego tienen los paneles PIR en comparación con la lana mineral?", answer: "Los paneles con núcleo PIR suelen alcanzar la Euroclase B-s2,d0 o B-s1,d0 — combustibilidad limitada y comportamiento autoextinguible. Los paneles de lana mineral (Rockwool) van más allá, alcanzando la A2-s1,d0, prácticamente incombustible, con resistencia al fuego de hasta 240 minutos en muros. Elige PIR para construcciones industriales y comerciales en general, y lana mineral cuando la normativa local o el seguro exijan un recubrimiento incombustible." },
      q7: { question: "¿Qué valor U puedo esperar de un panel aislante de 100 mm?", answer: "Un panel con núcleo PIR de 100 mm suele entregar un valor U cercano a 0.22 W/m²K, mientras que un panel de lana mineral del mismo espesor se ubica más cerca de 0.38 W/m²K. En términos prácticos, el PIR aísla mejor por milímetro de espesor, por lo que los paneles de lana mineral normalmente necesitan mayor espesor para igualar el mismo desempeño térmico." },
      q8: { question: "¿Los paneles sándwich son aptos para cuartos fríos?", answer: "Sí, de hecho los paneles con núcleo PUR/PIR son el estándar de la industria para cámaras frigoríficas y cuartos fríos. Su baja conductividad térmica (λ ≈ 0.022–0.024 W/m·K), combinada con juntas machihembradas herméticas, evita puentes térmicos y condensación, manteniendo los entornos de cadena de frío estables e higiénicos." },
      q9: { question: "¿Cuántos tornillos se necesitan por metro cuadrado de panel?", answer: "Como estimación general, se utilizan alrededor de 1.1 tornillos por metro cuadrado de panel. La cantidad exacta, el espaciamiento y la distribución dependen de los cálculos de carga por viento y sismo del proyecto, por lo que siempre debe confirmarlo el ingeniero estructural antes de la instalación." },
      q10: { question: "¿Cuál es la diferencia entre paneles de muro y paneles de techo?", answer: "Los paneles de techo incluyen un perfil trapezoidal que aumenta su capacidad de carga en pendientes y mejora el desagüe pluvial. Los paneles de muro suelen ser planos o con nervaduras ligeras, priorizando la estética, y pueden fabricarse con sistemas de fijación oculta para una fachada más limpia y sin tornillos visibles." },
      q11: { question: "¿Los paneles sándwich funcionan bien en zonas sísmicas como México?", answer: "Sí. Al ser un recubrimiento ligero y no estructural, las fuerzas sísmicas las absorbe el marco de acero y no el panel, lo que reduce la masa sísmica total del edificio — una ventaja importante bajo las disposiciones de diseño sísmico de la NTC-2017 en México." },
      q12: { question: "¿Cuánto duran los paneles sándwich aislantes?", answer: "Con una instalación correcta y mantenimiento del recubrimiento, los paneles con lámina de acero suelen alcanzar una vida útil de 25 a 40 años. El núcleo aislante —PIR, PUR o lana mineral— no se degrada en condiciones normales mientras las juntas del panel se mantengan bien selladas contra la humedad." },
      q13: { question: "¿Cuánto cuesta un panel sándwich aislante por metro cuadrado?", answer: "El precio depende en gran medida del tipo de núcleo, el espesor y el acabado: los paneles con EPS quedan en el rango económico, el PIR en un rango medio, y la lana mineral en el más alto debido a su densidad y desempeño ante el fuego. Como las especificaciones varían mucho según el proyecto, recomendamos solicitar una cotización personalizada para un precio preciso." },
    },
  },
  contact: {
    meta: {
